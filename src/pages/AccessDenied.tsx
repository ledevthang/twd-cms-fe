...
import accessIcon from '@/assets/images/access/asset-access.svg';

const AccessDeniedPage = () => {
  return (
    <div className='surface-ground flex align-items-center justify-content-center min-h-full min-w-full overflow-hidden'>
      <div className='flex flex-column align-items-center justify-content-center'>
        ...
        >
          ...
          >
            ...
            <img src={accessIcon} alt='Error' className='mb-5' width='80%' />
